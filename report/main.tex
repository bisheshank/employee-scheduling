...
Approximately 20--30 hours total. The majority was spent on the initial 4-variable model and debugging, followed by the realization that a simpler model worked better. Building the validator proved invaluable for catching edge cases and gave us confidence when experimenting with optimizations.
